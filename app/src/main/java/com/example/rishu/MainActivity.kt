...
import com.example.nil.N
import com.example.nil.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private var myNumbers:N = N()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = DataBindingUtil.setContentView(this,N.layout.activity_main)
